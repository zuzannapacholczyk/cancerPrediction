...
Użytkownik ma możliwość podania ścieżki do pliku z danymi, na podstawie których ma zostać zbudowany klasyfikator. Jeśli informacje te nie zostaną dostarczone, wykorzystane zostaną dane zaczerpnięte z UCI Marchine Learning Repository (https://archive.ics.uci.edu/ml/datasets/Breast+Cancer+Wisconsin+%28Original%29) i wcześniej zbudowany klasyfikator.
